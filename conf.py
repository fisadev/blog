...
BLOG_AUTHOR = "Juan Pedro Fisanotti"  # (translatable)
...
BODY_END = """
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-10031421-14"></script>
    <script>
...
# set this to true.
METADATA_UNSLUGIFY_TITLES = True
